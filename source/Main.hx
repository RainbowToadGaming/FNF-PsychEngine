...
class Main extends Sprite
{
	...
	static var gameInitialized:Bool = false;
	...
	public function new()
	{
		...
		// -------------------------
		// SAFE GAME OPTIMIZATIONS
		// -------------------------
		Application.current.window.onRender.add(function(_) {
			if (FlxG != null && FlxG.game != null && !gameInitialized) {
				...
				FlxG.drawFramerate = 0; // disables internal FPS drawing
